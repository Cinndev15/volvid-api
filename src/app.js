    ...
    <div class="table-container">
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td><span class="method-badge post">POST</span></td>
            <td><span class="endpoint-path">/api/auth/forgot-password</span></td>
            <td><span class="endpoint-desc">Solicita la recuperación de contraseña enviando las instrucciones al correo electrónico del usuario.</span></td>
            <td><span class="security-badge">PUBLIC</span></td>
          </tr>
          <tr>
            <td><span class="method-badge post">POST</span></td>
